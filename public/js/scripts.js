    ...
    (Neela = {
        ...
        build: function () {
            ...
            e.neelaStyle(),
                ...
                e.googleMap(),
                e.createLightboxGallery(),
                e.createBackgroundSlideshow(),
                e.createOwlSliders(),
                e.createGallery(),
                e.bgImageGrid(),
                e.countdown(),
        ...
        preloader: function () {
            var e = setInterval(function () {
                /loaded|complete/.test(document.readyState) &&
                    (clearInterval(e), u("#preloader").fadeOut(1e3));
            }, 10);
        },
        navigation: function () {
            u(".nav li a").on("click", function (e) {
                ...
                if (
                    u.browser.mobile &&
                    (!t.closest(".dropdown").hasClass("open") ||
                        "block" ===
                            t.closest(".dropdown-menu").css("display") ||
                        !t.parent().parent().hasClass("nav"))
                )
                    return e.preventDefault(), !1;
                "#" === t.attr("href").charAt(0) && u(t.attr("href")).length
                    ? (e.preventDefault(),
                      "#hero" !== t.attr("href") &&
                          null !== u(t.attr("href")).offset() &&
                          (a = u(t.attr("href")).offset().top - 55),
                      u("html, body")
                          .stop()
                          .animate(
                              { scrollTop: a },
                ...
                u(".nav-section.light").length &&
                    u(window).on("scroll load", function () {
                        180 < u(window).scrollTop()
                            ? u(".nav-section.light").addClass("sticky")
                            : u(".nav-section.light").removeClass("sticky");
                    }),
                0 !== u("#wrapper > section, #wrapper > div#hero").length &&
                    this.onepageNav &&
                    jQuery().waypoint &&
                    u("#wrapper > section, #wrapper > div#hero").waypoint({
                        element: u("#wrapper > section"),
                        handler: function (e) {
                            var t = u(this),
                                a = t[0].element.id;
                            "up" === e &&
                                (a = t[0].element.previousElementSibling.id),
                                u(".nav a").removeClass("active"),
                                (u(window).scrollTop() < 100
                                    ? u('.nav a[href="#hero"]')
                                    : u('.nav a[href="#' + a + '"]')
                                ).addClass("active");
                        },
                ...
                u(window).on("load", function () {
                    ...
                    "" !== e &&
                        ...
                        void 0 !== window.Waypoint &&
                            new Waypoint.Sticky({ element: u(".nav-section") });
                });
        },
        createMobileMenu: function (e) {
            ...
            null !== e && (e = u(window).innerWidth()),
                e <= 975 &&
                    ...
                    u(".nav-mobile > ul").html(u(".nav").html()),
                    u(".nav-mobile b, .nav-mobile .nav-logo").remove(),
                    u(".nav-mobile ul.dropdown-menu")
                        .removeClass()
                        .addClass("dropdown-mobile"),
                    u(".navbar > a.btn").length &&
                        (u(".navbar > a.btn").each(function () {
                    ...
                    (n = u(".nav-mobile")),
                    u("#nav-mobile-btn").on(i, function (e) {
                        e.stopPropagation(),
                            e.preventDefault(),
                            setTimeout(function () {
                                o.addClass("open"), n.addClass("open");
                            }, 25),
                            u(document).on(i, function (e) {
                                u(e.target).hasClass("nav-mobile") ||
                                    u(e.target).parents(".nav-mobile").length ||
                                    (o.removeClass("open"),
                                    n.removeClass("open"),
                                    u(document).off(i));
                            }),
                    ...
                    (t.mobMenuFlag = !0),
                    u(".nav-mobile li a").on("click", function (e) {
                        var t = u(this),
                            a = 0;
                        "#hero" !== t.attr("href") &&
                            (a = u(t.attr("href")).offset().top - 65),
                            u("html, body")
                                .stop()
                                .animate(
                                    { scrollTop: a },
        ...
        heroHeight: function () {
            this.heroFullScreen &&
                (u("#hero").css({ minHeight: u(window).innerHeight() + "px" }),
                u(window).resize(function () {
                    var e = parseInt(u("#hero").css("padding-bottom")) + 70,
                        t = parseInt(
                            u("#hero").next("section").css("margin-top")
                        ),
                        a = u(window).innerHeight() - e,
                        n = u("#hero >.container").height(),
                        o = -10;
                    t < 0 && !Number.isNaN(t) && (a += t + e),
                        (n = a - n),
                        u(".nav-section.light").length && (o = 10),
                        0 < n &&
                            u(".v-center").length &&
                            u("#hero >.container").css({
                                "margin-top": n / 2 + o + "px",
                            }),
                        u("#hero").css({
        ...
        bgImageGrid: function () {
            u("#freewall").length &&
                (u("#freewall .item").each(function () {
                    var e = u(this);
                    e.width(Math.floor(260 + 200 * Math.random())),
                        e.css({
                            "background-image":
                                "url(" + u(">img", e).attr("src") + ")",
                        }),
                        u(">img", e).remove();
                }),
                u("#freewall").appendTo("#wrapper"),
        ...
        googleMap: function () {
            ...
            if (
                0 === u(".gmap").length ||
                "undefined" === l.mapMarkers ||
                0 === l.mapMarkers.length ||
                void 0 === window.google
            )
                return !1;
            (/^\d|\.|-$/.test(l.mapInitialLatitude) &&
                /^\d|\.|-$/.test(l.mapInitialLongitude)) ||
                ((l.mapInitialLatitude = l.mapMarkers[0].latitude),
                (l.mapInitialLongitude = l.mapMarkers[0].longitude)),
                (t = new google.maps.LatLng(
                    l.mapInitialLatitude,
                    l.mapInitialLongitude
                )),
                l.useDefaultMapStyle ||
                    (c = [
                        {
                            stylers: [
                                { hue: l.mapColor },
                ...
                (e = new google.maps.StyledMapType(c, { name: "Neela" })),
                (i = google.maps.ControlPosition.RIGHT_CENTER),
                (r = google.maps.ControlPosition.RIGHT_BOTTOM),
                (c = google.maps.ControlPosition.RIGHT_TOP),
                l.rtlFlag &&
                    ((i = google.maps.ControlPosition.LEFT_CENTER),
                    (r = google.maps.ControlPosition.LEFT_BOTTOM),
                    (c = google.maps.ControlPosition.LEFT_TOP)),
                (a = {
                    center: t,
                    ...
                    mapTypeControl: !1,
                    zoomControl: !0,
                    zoomControlOptions: { position: i },
                    streetViewControlOptions: { position: r },
                    fullscreenControlOptions: { position: c },
                }),
        ...
        createOwlSliders: function () {
            u(".timeline-gallery").length &&
                u(".timeline-gallery").owlCarousel({
                    nav: !0,
                    dots: !1,
                    responsive: { 0: { items: 1 } },
                    rtl: this.rtlFlag,
                }),
                u(".testimonials").length &&
                    u(".testimonials").owlCarousel({
                        nav: !1,
                        dots: !0,
                        responsive: { 0: { items: 1 } },
                        rtl: this.rtlFlag,
        ...
        createGallery: function () {
            var e = u(".gallery-scroller"),
                t = !1;
            u(".gallery-scroller").length &&
                (u(".gallery-right").on("click", function () {
                    return (
                        !t &&
                        ((t = !0),
                        void e.animate(
        ...
        countdown: function () {
            ...
            u(".countdown").length &&
                ((o = function (e, t, a) {
                    ...
                    (n = Math.floor((o / 864e5) * 1)),
                        (a = Math.floor(((o % 864e5) / 36e5) * 1)),
                        (e = Math.floor((((o % 864e5) % 36e5) / 6e4) * 1)),
                        (o = Math.floor(
                            ((((o % 864e5) % 36e5) % 6e4) / 1e3) * 1
                        )),
                        u(".days > div", t).html(n),
                        u(".hours > div", t).html(a < 10 ? "0" + a : a),
                        u(".minutes > div", t).html(e < 10 ? "0" + e : e),
                        u(".seconds > div", t).html(o < 10 ? "0" + o : o);
                }),
        ...
        parallaxBg: function () {
            var o = this;
            !u.browser.mobile && 992 < u(window).innerWidth()
        ...
        windowResize: function () {
            ...
            u(window).resize(function () {
                ...
                t.createMobileMenu(e),
                    t.blogMetas(),
                    u(window).innerWidth() < 751 &&
                        (u(".navbar > a.btn").addClass("btn-sm"),
                        u(".navbar > a.btn").width("auto"));
            });
        },
        resizeVideos: function () {
            ...
            e.each(function () {
                ...
                (t < 0.3 || 0.8 < t || Number.isNaN(t)) && (t = 0.559),
                    e
                        .attr("data-aspectRatio", t)
                        .removeAttr("height")
                        .removeAttr("width");
            }),
                u(window)
        ...
        objEvents: function () {
            u(".btn").each(function () {
                ...
                2 < n || 0 !== e.find("i").length ? (a = 15) : 1 < n && (a = 8),
                    e.width(Math.round(t) + a);
            }),
                u("#about-us .element .image").on("mouseenter", function () {
                    var e = u(this);
                    if (
                        e.parent().is(":first-child") &&
                        !u(">.divider-about-us", e.closest(".row")).hasClass(
                            "flip"
                        )
                    )
                        return !1;
                    e.hasClass("flip") ||
                        ((u("#about-us .element .image.flip").length
                            ? u("#about-us .element .image")
                            : e
                        ).toggleClass("flip"),
                        u(">.divider-about-us", e.closest(".row")).toggleClass(
                            "flip"
                        ));
                }),
                u("#map_canvas")
                ...
                u(".overflow-image").length &&
                    u(".overflow-image").each(function () {
                        var e = u(this);
                        e.css({
                            "background-image":
                                "url(" + u(">img", e).attr("src") + ")",
        ...
        animateElems: function () {
            function e() {
                u("[data-animation-delay]").each(function () {
                    ...
                    e.addClass("animate-" + o),
                        u(document).ready(function () {
                            t + a >= e.offset().top &&
                                (Number.isNaN(n) || 0 === n
                                    ? e
                                          .removeClass("animate-" + o)
                                          .addClass("animation-" + o)
                                    : setTimeout(function () {
                                          e.removeClass("animate-me").addClass(
                                              "animation-" + o
                                          );
                                      }, n));
                        });
            ...
            751 <= u(window).innerWidth()
                ? (u(window).scroll(function () {
                      e();
                  }),
                  e())
                : u("[data-animation-delay]").addClass("visible");
        },
    }).init();
})(jQuery);
